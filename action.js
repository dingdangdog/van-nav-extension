...
const openGithubElement = document.querySelector("#openGithub");
...
openGithubElement.addEventListener("click", handleOpenGithub);
...
chrome.storage.sync.get(
  ["baseUrl", "token", "options", "lastOption"],
  function (result) {
...
function handleOpenGithub() {
  chrome.tabs.create({ url: "https://github.com/dingdangdog/van-nav-extension" });
}
